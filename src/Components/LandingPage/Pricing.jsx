...
const Pricing = () => {
  return (
    <section className=" bg h-screen  py-5 px-16 flex flex-col space-y-10  w-full">
      ...
      <section className="flex space-x-5 text-white border-2 border-slate-400  p-6 rounded-md">
