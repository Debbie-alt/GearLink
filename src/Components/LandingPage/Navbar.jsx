  ...
  return (
    <nav className="  flex justify-between w-full text-white">
        ...
        <AlignLeft size={22} />
          ...
          <a href="" className="hover:opacity-90 hover:text-yellow-300 text-yellow-400 "  >Home</a>
          <a href="#howitWorks" className="hover:opacity-90 hover:text-yellow-300"> How it works</a>
          <a href="" className="hover:opacity-90 hover:text-yellow-300"> Vendor </a>
          <a href="#pricing" className="hover:opacity-90 hover:text-yellow-300"> Pricing </a>
          <a href="" className="hover:opacity-90 hover:text-yellow-300"> About Us</a>
        </div>

           
        <a
          href="../../../Pages/SignUp.jsx"
          role="button"
