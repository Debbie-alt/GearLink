  ...
  return (
    <section className="w-screen h-auto p-20 space-y-14 flex flex-col ">
      <div className="flex flex-col text-center space-y-4" >
        <h1 className="font-bold  text-xl heading" data-aos="fade-right" data-aos-delay="500">Features</h1>
        <p className="font-roboto" data-aos="fade-right" data-aos-delay="500" >
